                        ...
                        <div class="card text-center">
                            <div class="card-header">
                                <ul class="nav nav-tabs card-header-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">廚房家電</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#">居家清潔</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">居家安全</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">智能周邊</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">娛樂與教育</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">其他類別</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">其他類別</a>
                                    </li>
                            ...
                            <div class="card-body">
                                <div class="minibtn">
                                    <a href="#" class="btn btn-light">掃地機器人</a>
                                    <a href="#" class="btn btn-light">拖地機器人</a>
                ...
                <div class="m_body">
                    <div class="m_card">
                        ...
                        <div class="card_center">
                            <img src="./img/212008_M2.jpeg" alt="">
                            <div class="r_rpart">
